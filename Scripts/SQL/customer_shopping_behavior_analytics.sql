...
---Q2. Which customers used a discount but still spent more than the average purchase amount?
	...
	(SELECT  avg(purchase_amount) AS Avg_Price
	FROM  customer c1
	WHERE  c.item_purchased = c1.item_purchased)
...
-----Q7. Segment customers into New, Returning, and Loyal based omtheirtotal numbemof
...
---Q9. Are customers who are repeat buyers (more than 5 previous purchases Yalso likel to subscribe?
	SELECT subscription_status,
